...
--*/
{
    ...
    UNICODE_STRING required_extension = RTL_CONSTANT_STRING(L"mkhoyan"); // юникод-строка с названием расширения
    ...
    if (!NT_SUCCESS(status))
    {
        ...
        //проверка на чтение
            ...
            if (strlen((char*)Data->Iopb->Parameters.Read.ReadBuffer) != 0) {
                ...
                uint8_t iv[] = { 0x75, 0x52, 0x5f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x65, 0x73
                    , 0x74, 0x69, 0x6e, 0x67, 0x21, 0x21 };
